                        ...
                        <div class="slider-content-area ">
                            <div class="content order-2 order-md-1">
                                ...
                                <div class="tittle-wrp">
                                    <h2>Subtitle To Write <span>Here.</span></h2>
                                </div>
                                <p>Lorem Ipsum is simply dummy text printing typesetting industry. orem Ipsum has been the industry.</p>
                                <n-link to="/" class="btn btn-theme btn-theme-color2">Buy Now! <i class="icon icofont-long-arrow-right"></i></n-link>
                            </div>
                            <div class="layer-style order-1 mb-30 order-md-2 ">
                                <div class="thumb">
