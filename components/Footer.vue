            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-6 col-xl-6">
                    <div class="widget-newsletter">
                                <form>
                                    <input type="email" class="form-control col-6" placeholder="Enter your email">
                ...
                <div class="col-md-4 col-lg-2 col-xl-2 lg-pr-0">
                    <!-- <div class="widget-item menu-wrap-column">
                        ...
                        <img class="line-shape" src="/images/shape/line-s1.png" alt="unstoppable-HasTech">
                        <nav class="widget-menu-wrap">
                            <ul class="nav-menu nav">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 order-2 order-md-1">
                            <div class="widget-copyright">
                                <p>© 2022 <span>Unstoppable</span> Made with <i class="icofont-heart"></i> by <a href="https://planetimpactpod.com/">Manthan Shah</a></p>
                            </div>
                        </div>
