...
import nuxt_plugin_plugin_56b91410 from 'nuxt_plugin_plugin_56b91410' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_c305c93c from 'nuxt_plugin_bootstrapvue_c305c93c' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Unstoppable","titleTemplate":"%s | Unstoppable","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_56b91410 === 'function') {
    await nuxt_plugin_plugin_56b91410(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_c305c93c === 'function') {
    await nuxt_plugin_bootstrapvue_c305c93c(app.context, inject)
  }
